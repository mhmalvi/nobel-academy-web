    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 page-content">
          ...
          <div class="page_nav">
        <span>You are here:</span> <a href="{{URL::to('/')}}">Home</a> <span><i class="fa fa-angle-double-right"></i>Contact Us</span>
        </div>
        </div>
      </div>
    </div>
      ...
      <div class="row padding-bottom">
        <div class="col-md-4 contact_address heading_space wow fadeInLeft" data-wow-delay="500ms">
          ...
          <div class="address">
            ...
            <h4>Visit Us</h4>
            <p>Suite 101, 124-128 Beamish St Campsie, NSW 2194</p>
          </div>
          <div class="address">
          ...
          <ul class="social_icon black top30">
            <li><a href="https://www.facebook.com/NTA.Australia/" class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="javascript:void(0)" class="twitter"><i class="icon-twitter4"></i></a></li>
            <li><a href="javascript:void(0)" class="dribble"><i class="icon-linkedin"></i></a></li>
            <li><a href="javascript:void(0)" class="instagram"><i class="icon-instagram"></i></a></li>
          </ul>
        </div>
