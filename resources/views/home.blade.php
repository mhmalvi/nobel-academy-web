...
<section id="about" class="padding">
    <div class="container">
        <h2 class="heading heading_space text-center" style="display: block;">About Us <span class="divider-center"></span></h2>
      <div class="row">
      <div class="icon_wrap padding-bottom-half clearfix">
        <div class="col-sm-4 icon_box text-center heading_space wow fadeInUp" data-wow-delay="500ms">
           ...
           <p class="no_bottom text-justify">We provide industry-specific knowledge and skills so you can become job-ready once you complete your qualification</p>
        </div>
        <div class="col-sm-4 icon_box text-center heading_space wow fadeInUp" data-wow-delay="400ms">
           ...
           <p class="no_bottom text-justify">Noble Training Academy (RTO code 70201) is Providing nationally accredited training and Recognition of Prior Learning Australia wide.</p>
        </div>
        <div class="col-sm-4 icon_box text-center heading_space wow fadeInUp" data-wow-delay="500ms">
           <i class="icon-laptop"></i>
           <h4 class="text-capitalize bottom20 margin10">RPL</h4>
           <p class="no_bottom text-justify">Recognition of prior learning is an assessment process that recognises an expert's knowledge and certifies it.</p>
        </div>
        </div>
      </div>
    </div> 
    <div class="container margin_top">
      <div class="row">
        <div class="col-md-7 col-sm-6 priorty wow fadeInLeft">
          <h2 class="heading bottom25">Why Choose Us <span class="divider-left"></span></h2>
          <div class="row">
              <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="about-post">
                <a href="#." class="border_radius"><img src="{{asset('assets/images/awesome.png')}}" alt="hands"></a>
        ...
        <div class="col-md-5 col-sm-6 wow fadeInRight">
           <img src="{{asset('assets/images/about/about01.jpg')}}" alt="our priorties" class="img-responsive" style="width:100%; padding-top:75px;">
        </div>
      </div>
    </div>
  </section>
                ...
                <div id="course_slider" class="owl-carousel">
                    <div class="item">
                        <div class="image bottom20">
                            <img src="{{asset('assets/images/courses/thumb01.jpg')}}" alt="Courses" class="img-responsive border_radius">
                        </div>
                        <h3 class="bottom15"><a href="{{route('diplomaInBeauty')}}" class="course_name">SHB50115 - Diploma in Beauty Therapy</a></h3>
                        <p class="bottom15">
                            <?php
                                echo mb_strimwidth($DBT, 0, 200, "...")  
                            ?>
                        </p>
                    ...
                    <div class="item">
                        <div class="image bottom20">
                            <img src="{{asset('assets/images/courses/thumb02.jpg')}}" alt="Courses" class="img-responsive border_radius">
                        </div>
                        <h3 class="bottom15"><a href="{{route('beautyTherapy')}}" class="course_name">SHB40115 - Certificate IV in Beauty Therapy</a></h3>
                        <p class="bottom15">
                            <?php
                            echo mb_strimwidth($CBT, 0, 200, "...")  
                            ?>
                        </p>
                    ...
                    <div class="item">
                        <div class="image bottom20">
                            <img src="{{asset('assets/images/courses/thumb03.jpg')}}" alt="Courses" class="img-responsive border_radius">
                        </div>
                        <h3 class="bottom15"><a href="{{route('hairdressing')}}" class="course_name">SHB30416 - Certificate III in Hairdressing</a></h3>
                        <p class="bottom15">
                            <?php
                            echo mb_strimwidth($CHD, 0, 200, "...")  
                            ?>
                        </p>
                    ...
                    <div class="item">
                        <div class="image bottom20">
                            <img src="{{asset('assets/images/courses/thumb04.jpg')}}" alt="Courses" class="img-responsive border_radius">
                        </div>
                        <h3 class="bottom15"><a href="{{route('diplomaInRemedial')}}" class="course_name">HLT52015 - Diploma in Remedial Massage</a></h3>
                        <p class="bottom15">
                            <?php
                            echo mb_strimwidth($DRM, 0, 200, "...")  
                            ?>
                        </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInDown text-center">
                <h2 class="heading heading_space">GRADUATES OF NOBLE TRAINING ACADEMY - RTO CODE 70201 <span class="divider-center"></span></h2>
                <p>HLT52015 - DIPLOMA OF REMEDIAL MASSAGE; WILL NOW BE ADMINISTERED TO THE INDIVIDUAL PRIVATE HEALTH FUNDS  FOR THE PURPOSES OF GAINING APPROVED PROVIDER STATUS. GRADUATES HAVE THE OPTION OF BEING ADMINISTERED BY ANY OF THE FOLLOWING ASSOCIATIONS, HOWEVER ITS NOT GUARANTEED BY THE RTO THAT YOU WILL GET IT AS IT IS SUBJECT TO APPROVAL BY THE ASSOCIATIONS POLICY-</p>
        ...
        <div class="row">
            ...
            <div class="col-md-6 d-flex justify-content-center" style="padding: 15px 0px;">
                <img src="{{asset('assets/images/logo/FCMA.png')}}" alt="FCMA" class="img-responsive border_radius" style="max-width: 150px; max-height: 150px;">
            </div>
            <div class="col-md-6 d-flex justify-content-center" style="padding: 15px 0px;">
                <img src="{{asset('assets/images/logo/MAA.png')}}" alt="MAA" class="img-responsive border_radius" style="max-width: 150px; max-height: 150px;">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-8">
                    <div class="card-body" style="padding: 0px;">
                        <h2 class="heading">How Can We Help?<span class="divider-left"></span></h2>
                        <div style="padding: 30px 0px;">
                            <p>We'd love to hear from you, please drop us a line if you have any query. We'll do our best to get back to you as soon as possible.</p>
                        </div>
