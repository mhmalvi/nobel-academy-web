            ...
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <div class="d-flex justify-content-center">
                        <img alt="image" class="rounded-circle" src="{{asset((Auth::user()->profile_photo_path)? 'public/storage/users/'.Auth::user()->profile_photo_path : 'assets/images/profile.jpg')}}" style="max-width: 48px;"/>
                    </div>
                </div>
